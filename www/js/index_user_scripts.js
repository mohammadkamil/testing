...
//var host = "http://localhost/BusTracking/";
    ...
    */
                ...
                success: function (data) {
                    ...
                    if (infoData.length > 0) {
                        ...
                        $.each(infoData, function (i, results) {
                            infoBussf = true;
                            clearInterval(infobuss);
                            var dialog = bootbox.dialog({
                                message: '<h1 align="center">Info Bus</h1><br><center><table ><tr><td>Title </td><td>: </td><td> ' + results.infobusTitle + '</td></tr><tr><td>Date Start </td><td>: </td><td> ' + moment(results.dateStart).format('l') + '</td></tr><tr><td>Date End </td><td>: </td><td> ' + moment(results.dateEnd).format('l') + '</td></tr><tr><td>Message </td><td>: </td><td> ' + results.infoMessage + '</td></tr></table></center>',
                                closeButton: true
                            });
                            ...
                            //                        temp.click(function () {
                            //                            $("#infobusdetail").html("<table><tr><td>Title </td><td>: </td><td> " + results.infobusTitle + "</td></tr><tr><td>Date Start </td><td>: </td><td> " + moment(results.dateStart).format("l") + "</td></tr><tr><td>Date End </td><td>: </td><td> " + moment(results.dateEnd).format('l') + "</td></tr><tr><td>Message </td><td>: </td><td> " + results.infoMessage + "</td></tr></table>");
                        ...
                        if (comNoMatric !== "" && comRoute !== "" && comDate !== "" && comTime !== "" && complaintreport !== "") {
                            if (checkEmail(comEmail) === true && checkNumberLenght(comNoMatric) === true) {
                                if (localStorage.getItem("emailPassenger") === null) {
                                    ...
                                    localStorage.setItem("nomatricPassenger", comNoMatric);
                                }
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        if (localStorage.getItem("emailPassenger") !== null) {
                                            $("#comEmail").val(localStorage.getItem("emailPassenger"));
                                            $("#comNoMatric").val(localStorage.getItem("nomatricPassenger"));
                                            $("#comEmail").prop('disabled', true);
                                            $("#comNoMatric").prop('disabled', true);
                ...
                success: function (data) {
                    ...
                    if (data != "0") {
                        $.each(complaintData, function (i, complaint) {
                            ...
                            temp = $('<li class="list-group-item justify-content-between" id="nocomplaint"><a><table><tbody><tr><td>Complainer </td><td>:</td><td> ' + complaint.noMatric + '</td></tr><tr><td>Route</td><td>:</td><td> ' + complaint.comRoute + '</td></tr><tr><td>Date</td><td>:</td><td> ' + moment(complaint.comDate).format('l') + '</td></tr><tr><td>Time</td><td>:</td><td> ' + moment(complaint.comTime, "HH:mm").format("hh:mm A") + '</td></tr><tr><td>Complaint</td><td>: </td><td> ' + complaint.complaint + '</td></tr><tr><td>Status</td><td>:</td><td> ' + complaint.comStatus + '</td></tr></tbody></table></a></li>');
                            //                        }
                            //                        if (complaint.comStatus == "verified") {
                            //                            temp = $('<li class="list-group-item justify-content-between" id="nocomplaint"><a><table><tbody><tr><td>Complainer </td><td>:</td><td>' + complaint.noMatric + '</td></tr><tr><td>Route</td><td>:</td><td>' + complaint.comRoute + '</td></tr><tr><td>Date</td><td>:</td><td>' + complaint.comDate + '</td></tr><tr><td>Time</td><td>:</td><td>' + complaint.comTime + '</td></tr><tr><td>Complaint</td><td>:</td><td>' + complaint.complaint + '</td></tr><tr><td>Status</td><td>:</td><td>'+complaint.comStatus+'</td></tr></tbody></table></a></li>');
                            //                        }
                            //                        if (complaint.comStatus == "completed") {
                            //                            temp = $('<li class="list-group-item justify-content-between" id="nocomplaint"><a><table><tbody><tr><td>Complainer </td><td>:</td><td>' + complaint.noMatric + '</td></tr><tr><td>Route</td><td>:</td><td>' + complaint.comRoute + '</td></tr><tr><td>Date</td><td>:</td><td>' + complaint.comDate + '</td></tr><tr><td>Time</td><td>:</td><td>' + complaint.comTime + '</td></tr><tr><td>Complaint</td><td>:</td><td>' + complaint.complaint + '</td></tr><tr><td>Status</td><td>:</td><td>'+complaint.comStatus+'</td></tr></tbody></table></a></li>');
                            //                        }
                        ...
                        temp = $('<li class="list-group-item justify-content-between" id="nocomplaint" style="margin-top:5%">You do report any complaint</li>');
                        $("#disComplaint").append(temp);
                    }
                ...
                if (parseInt(xhr.status) == 200) {
                    ...
                    if (json_string.length > 0) {
                        ...
                        $.each(json_string, function (i, results) {
                            ...
                            temp = $('<li class="list-group-item justify-content-between" id="nomissitem"><a><table><tr><td style="width:20%;height:20%"><img src="' + hostGambar + results.missIMG + '" style="width:100%;">                      </td><td style="padding:0% 0% 0% 2%"><h4>Date ' + results.missType + ': ' + moment(results.missDate).format('l') + '</h4></td></tr></table></a></li>');

                            temp.click(function () {
                                $("#missIMG").attr("src", hostGambar + results.missIMG);
                                if (results.missContact === "null") {
                                    $("#missDetail").html("<table><tr><td>Route </td><td>: </td><td> " + results.missRoute + "</td></tr><tr><td>Date report </td><td>: </td><td> " + moment(results.missDate).format('l') + "</td></tr><tr><td>Time report </td><td>: </td><td> " + moment(results.missTime, "HH:mm").format("hh:mm A") + "</td></tr><tr><td>From </td><td>: </td><td sytle='padding-left:40%'> " + results.missFrom + "</td></tr><tr></table>");
                                } else {
                                    $("#missDetail").html("<table><tr><td>Route </td><td>: </td><td> " + results.missRoute + "</td></tr><tr><td>Date report </td><td>: </td><td> " + moment(results.missDate).format('l') + "</td></tr><tr><td>Time report </td><td>: </td><td> " + moment(results.missTime, "HH,mm").format("hh:mm A") + "</td></tr><tr><td>From </td><td>: </td><td sytle='padding-left:40%'> " + results.missFrom + "</td></tr><tr><td>Contact No. </td><td>:   </td><td> " + results.missContact + "</td></tr></table>");
                                }
    ...
    function onPhotoDataSuccess(imageData) {
       ...
       // var photo = 'data:image/jpeg;base64,' + imageData;
        ...
        $(document).on("click", "#btnreport2", function (evt) {
            ...
            bootbox.confirm({
                title: "Comfirmation Report?",
                message: "Do you want to submit Reportdd",
                buttons: {
                    cancel: {
                        label: '<i class="fa fa-times"></i> Cancel'
                    },
    ...
    function onPhotoURISuccess(imageURI) {
        ...
        $(document).on("click", "#btnreport", function (evt) {
            ...
            bootbox.confirm({
                title: "Comfirmation Report?",
                message: "Do you want to submit Reportaaa",
                buttons: {
                    cancel: {
                        label: '<i class="fa fa-times"></i> Cancel'
                    },
...
function timer(response, status) {
    ...
    if (timearrive <= minutess) {
        ...
        bootbox.alert("Bus have will arrive");
        //        navigator.notification.vibrate(3000);
        //        navigator.notification.beep(3);
        cordova.plugins.notification.local.schedule({
            icon: "file://logo-bus35.png",
