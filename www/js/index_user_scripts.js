...
var missRouteP, MissDateP, MissTimeP, MissfromP,MisstypeP; //report missing item variable
        ...
        $(document).on("click", "#slideInfo", function (evt) {
            ...
            uib_sb.toggle_sidebar($("#slidemenu"));
              $.ajax({
                //Getting the url of the uploadphp from action attr of form 
                //this means currently selected element which is our form 
                url: "http://localhost/BusTracking/getInfoBus.php",
                ...
                if (parseInt(xhr.status) == 200) {
                    ...
                    if (json_string.length > 0) {
                        ...
                        $.each(json_string, function (i, results) {
                            ...
                            temp.click(function () {
                                $("#missIMG").attr("src", hostGambar + results.missIMG);
                                $("#missDetail").html("<table><tr><td>Route </td><td>: </td><td> " + results.missRoute + "</td></tr><tr><td>Date report </td><td>: </td><td> " + results.missDate + "</td></tr><tr><td>Time report </td><td>: </td><td> " + results.missTime + "</td></tr><tr><td>From </td><td>: </td><td> " + results.missFrom + "</td></tr></table>");
                                activate_subpage("#missingItemDetail");
                            });
